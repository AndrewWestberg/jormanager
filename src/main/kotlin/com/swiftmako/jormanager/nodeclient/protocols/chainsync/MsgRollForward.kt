...
import com.swiftmako.jormanager.nodeclient.protocols.chainsync.MsgRollForward.Companion.MESSAGE_ID
...
object MsgRollForwardAdapter {
    ...
    fun fromCborArray(cborArray: CborArray): MsgRollForward {
        assert(MESSAGE_ID == cborArray.elementToLong(0))
        ...
        val nonceVrfFirstPart = nonceCborArray.elementToHexString(0)
        val nonceVrfSecondPart = nonceCborArray.elementToHexString(1)
        ...
        val someNumber1 = blockHeaderCborArrayInner.elementToLong(10)
        val kesPeriod = blockHeaderCborArrayInner.elementToLong(11)
        val someHashMaybeKesRelated = blockHeaderCborArrayInner.elementToHexString(12)
        ...
        return MsgRollForward(blockNumber, slotNumber, prevHash, nodeVkey, nodeVrfVkey, blockSize, blockBodyHash, poolOpcert, kesPeriod, protocolMajorVersion, protocolMinorVersion)
    }
}
...
//  ],
//  // some hash or signature of the header??
