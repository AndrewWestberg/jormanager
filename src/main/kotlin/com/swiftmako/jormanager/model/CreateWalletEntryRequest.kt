...
data class CreateWalletEntryRequest(
    ...
    override fun toString(): String = "CreateWalletEntryRequest(spendingPassword='************', name='$name', type='$type', paymentAddr='$paymentAddr', generateKeys=$generateKeys, paymentSKey=***, paymentVKey=***, stakingSKey=***, stakingVKey=***)"
}
