...
data class JormSettings(
        @Json(name = "block0Time") val block0Time: String,
        @Json(name = "slotDuration") val slotDurationSec: Long,
        @Json(name = "slotsPerEpoch") val slotsPerEpoch: Long
)
...
/*
{
  ...
  "currSlotStartTime": "2020-01-16T17:12:38+00:00",
