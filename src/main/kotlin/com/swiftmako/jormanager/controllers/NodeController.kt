...
import com.swiftmako.jormanager.model.metadata.pool.*
        ...
        try {
            ...
            when (request.type) {
                NODE_TYPE_RELAY -> {
                    ...
                    nodesChannel.trySend(savedNode)
                ...
                NODE_TYPE_CORE, NODE_TYPE_POOL -> {
                    ...
                    val byronToShelleyEpochs = if (genesisShelley.networkId.equals("testnet", ignoreCase = true)) {
                        if (genesisShelley.networkMagic == TESTNET_NETWORK_MAGIC) {
...
//                }
    ...
    private fun createBulkCredentials(
        hostConnection: HostConnection,
        nodeFolder: String,
        credentials: MutableList<List<Key>>
    ) {
    ...
    companion object {
        ...
        private const val TESTNET_NETWORK_MAGIC = 1097911063L
    }
}